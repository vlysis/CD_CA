...
* The tidy output file "subject_activity_means_tidied.txt" contains 66 variables, this is a significant reduction reduction from 561 original variables.  Only variables that were the results of computing mean and standard deviation for a measurement were kept in this analysis.
